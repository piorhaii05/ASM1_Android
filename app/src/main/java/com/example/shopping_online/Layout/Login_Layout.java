...
public class Login_Layout extends AppCompatActivity {
    ...
    private TextView txt_Admin, txt_User, txt_forgot_Password, txt_goto_Register;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_goto_Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Login_Layout.this, Register_Layout.class));
            }
        });
    ...
    private void loginAccount() {
        ...
        if (validate) {
            firebaseAuth.signInWithEmailAndPassword(user, pass).addOnCompleteListener(Login_Layout.this, new OnCompleteListener<AuthResult>() {
                @Override
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(Login_Layout.this, "Đăng nhập thành công", Toast.LENGTH_LONG).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Login_Layout.this, "Tài khoản hoặc mật khẩu của bạn không chính xác", Toast.LENGTH_LONG).show();
